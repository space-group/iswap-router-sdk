...
export declare class RouteV2<TInput extends Currency, TOutput extends Currency>
...
export declare class MixedRoute<TInput extends Currency, TOutput extends Currency>
